...
public class OrderServiceImpl implements OrderService {
    ...
    public void updateStatus(String outtradeno, String paytime, String transactionid) throws Exception{
        ...
        order.setPayStatus("1"); // 支付状态：支付成功
        order.setTransactionId(transactionid); // 流水号id
    ...
    public void add(Order order){
         ...
         */
        order.setId(String.valueOf(idWorker.nextId())); // 主健ID
        // 获取购物车明细 -> 购物车集合
        ...
        order.setIsDelete("0"); // 删除状态  0：未删除
        /**
        ...
        order.setPayMoney(totalMoney); // 实付金额 -- 有优惠价格的时候，就不一样
        // 添加订单信息
        orderMapper.insertSelective(order);
        // 循环添加订单明细信息
        orderItems.parallelStream().forEach(t ->{
            orderItemMapper.insertSelective(t);
        });
