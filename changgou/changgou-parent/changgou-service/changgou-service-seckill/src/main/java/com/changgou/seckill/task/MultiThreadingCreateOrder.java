...
public class MultiThreadingCreateOrder {
    ...
    public void createOrder(){
        try {
            ...
            seckillOrder.setId(idWorker.nextId()); // 赋予一个id值
             ...
             */
            redisTemplate.boundHashOps("SeckillOrder").put(username, seckillGoods);
...
//            if (seckillGoods.getStockCount() <= 0) {
            ...
            // 更新下单状态
            seckillStatus.setOrderId(seckillOrder.getId()); // 取出上面赋予的id值
            ...
            System.out.println("下单时间："+sdf.format(new Date()));
            // 发送消息给延时队列
            rabbitTemplate.convertAndSend("delaySeckillQueue", (Object) JSON.toJSONString(seckillStatus), new MessagePostProcessor() {
                ...
                public Message postProcessMessage(Message message) throws AmqpException {
                    message.getMessageProperties().setExpiration("10000"); // 10秒超时
                    return message;
                }
            });
