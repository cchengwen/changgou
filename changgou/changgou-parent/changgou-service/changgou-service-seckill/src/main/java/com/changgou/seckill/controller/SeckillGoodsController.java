...
public class SeckillGoodsController {
    ...
    public Result<SeckillGoods> one(String time, Long id){
        ...
        return new Result<SeckillGoods>(true, StatusCode.OK, "查询秒杀商品详情成功！", goods);
    }
    ...
    public Result<List<SeckillGoods>> list(String time){
        List<SeckillGoods> goods= seckillGoodsService.list(time);
        return new Result<List<SeckillGoods>>(true, StatusCode.OK, "秒杀商品列表查询成功！", goods);
    }
