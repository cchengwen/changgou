...
public class WeixinPayServiceImpl implements WeixinPayService {
    ...
    public Map createnative(Map<String, String> parameterMap) {
        try {
            ...
            // 获取自定义数据
            String exchange = parameterMap.get("exchange"); // 交换机
            String routingKey = parameterMap.get("routingkey"); // 路由名称
            String username = parameterMap.get("username"); // 用户名
            ...
            paramMap.put("attach", attach); // 自定义数据
